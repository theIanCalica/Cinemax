...
const Footer = () => {
  return (
    <footer className="footer bg-black mt-5">
      ...
      <div
        className="flex justify-between items-center px-auto"
      ...
      >
        ...
        <div className="max-w-40">
          <h5 className="text-white text-m font-semibold tracking-wide leading-tight font-sans">
        ...
        <div className="text-white">
          <div className="text-themeYellow font-bold relative inline-block">
            Movies
        ...
        <div className="text-white">
          ...
          <ul className="space-y-1 mt-5 text-gray-500">
            <li className="relative hover:text-orange-500 transition-all duration-700">
